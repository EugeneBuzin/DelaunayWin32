...
Скажу сразу, сделал я это не для коммерческого использования. Причина была в том, что мне хотелось разобраться в процессе триангуляции. А в комментариях к triangle у Джонотана Ричарда Шевчука написано: Private, research, and institutional use is free. Т.е. Частное, исследовательское и институциональное использование бесплатно.
