...
Как видно из строки кода case WM_CREATE: путь по умолчанию к входнм и выходным данным определяется при создании окна приложения во время выполнения функции CreateWindowW.
