...
Файл может содержать комментарии, помеченные символом #. В примере, каждая последующая строка содержит: порядковый номер вершины, координату X вершины, координату Y вершины.
