...
Затем, вызывается функция DivideAndConquer::divconqRecurse, которая собственно и выполняет триангуляцию Делоне. Определение этой функции см. в файле DivideAndConquer.cpp в строках 421 - 579.
